...
for ARGI; do
	...
	printf "Options:                                        \n"
	printf "  --evan, -e   Launch the vehicle EVAN          \n" 
	printf "  --felix, -f  Launch the vehicle FELIX         \n" 
	printf "  --gus, -g    Launch the vehicle GUS           \n" 
	printf "  --hal, -h    Launch the vehicle HAL           \n" 
	printf "  --red, -r    Launch the RED Team EVAN,FELIX   \n" 
	printf "  --blue, -b   Launch the BLUE Team, GUS,HAL    \n" 
