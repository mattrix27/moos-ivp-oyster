...
#include <iostream>
#include "iActuationKFAC_ExampleConfig.h"
...
void showExampleConfig()
{
    blk("                                                                ");
    blk("=============================================================== ");
    blk("iActuationKFAC Example MOOS Configuration                         ");
    blk("=============================================================== ");
    blu("Blue lines: ","Default configuration                            ");
    blk("                                                                ");
    blk("ProcessConfig = iActuationKFAC                                   ");
    blk("{                                                               ");
    ...
    blu("  Timeout = 6                                                   ");
    blu("  NO_COMMS_TO_KFISHER = false  // When true, operates without   ");
    blu("                                  connection with the vehicle                   ");
    blu("  VERBOSE        = false  // When true, outputs info to console ");
    blk("                                                                ");
    blu("  CRITICAL_VOLTAGE = 11                                         ");
    blu("  CRITICAL_CURRENT = 2                                          ");
    blu("  CRITICAL_CURRENT_TIMEOUT = 1                                  ");
    blk("                                                                ");
