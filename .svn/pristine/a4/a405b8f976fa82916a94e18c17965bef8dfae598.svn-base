...
int main(int argc, char *argv[])
{
    ...
    if(vers_requested) {
        showReleaseInfo("iActuationKFAC", "gpl");
        return(0);
    }
    ...
    if((mission_file == "") || help_requested) {
        cout << "Usage: iActuationKFAC file.moos [OPTIONS]            " << endl;
        cout << "                                                    " << endl;
        cout << "Options:                                            " << endl;
    ...
    cout << "iActuationKFAC running as: " << run_command << endl;
    cout << termColor() << endl;

    ActuateKFAC ActuateKFAC;

    ActuateKFAC.Run(run_command.c_str(), mission_file.c_str());
